...
async function submitIngredient(
  ...
  try {
    ...
    errorMessage.value = getErrorMessage(error, 'Nao foi possivel criar o ingrediente.')
  } finally {
    pending.value = false
  }
}
  ...
  <AdminShell>
    <section class="admin-page-header">
      <div>
        ...
        <p class="admin-page-header__sub">Cadastre o ingrediente mestre antes de vincula-lo as receitas.</p>
      </div>
